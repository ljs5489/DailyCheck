...
public class PrecheckDAO {
	private static Precheck makeStudent(ResultSet resultSet)
			throws SQLException {
	...
	public static void insertInfo(String id, String checktime, String checker,
			String ars, String mail, String fax, String vrs, String messanger,
			String leaseloan, String visual, String images, String font,
			String links, String bbs, String indexsize, String WMtime,
			String WMstate, String WMpump, String WMaircon,
			String WMtemperature, String WEtime, String WEstate, String WEpump,
			String WEaircon, String WEtemperature, String EMtime,
			String EMstate, String EMpump, String EMaircon,
			String EMtemperature, String EEtime, String EEstate, String EEpump,
			String EEaircon, String EEtemperature, String ifany)
			throws Exception {
		Precheck precheck = null;
		Connection connection = null;
		PreparedStatement statement = null;
		...
		try {
			connection = DB.getConnection();
			String sql = "";
			sql += "INSERT INTO precheck(id,checkTime,checker, ars ,mail"
					+ ",fax ,vrs,messanger ,leaseloan ,visual "
