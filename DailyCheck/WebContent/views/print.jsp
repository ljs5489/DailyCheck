	...
	<table cellspacing="0" cellpadding="0" class="no_bd top1">
		...
		<table cellspacing="0" cellpadding="0" class="datatable">
			...
			<tbody>
				...
				<tr><%=PrintSets.getTd(3, new String[] { "<b>TFSKR-FAX</b>", "", "<td style='padding:0px;'>"+PrintSets.setTable(1, new String[] {server.getFAX_disk1(),server.getFAX_disk2()})+"</td>", "-", PrintSets.onToY(server.getFAX_CPU())+" "+server.getFAX_value(), PrintSets.onToY(server.getFAX_memory())+" / "+PrintSets.whenOverLimit(server.getFAX_value_2(),65), PrintSets.onToY(server.getFAX_vaccine()),PrintSets.onToY(server.getFAX_update()),PrintSets.onToGood(server.getFAX_status()) })%></tr>				
