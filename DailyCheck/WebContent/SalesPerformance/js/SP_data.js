...
var FYld = [ //[ '지점', '목표 금액', '현재 금액 ', '목표M/S','현재M/S' ], 
           [ '지점', '목표 금액', '현재 금액 ', '목표M/S', '현재M/S' ],
			[ "4월", 1321, 231, 31.1,13.15 ], 
			[ "5월", 1332, 221, 26.7,14.28 ], 
			[ "6월", 1523, 361, 34.8,22.58 ], 
			[ "7월", 1269, 659, 30.3,24.39 ], 
			[ "8월", 507, 622, 30.9,28.57 ], 
			[ "9월", 886, 191, 27.3,36.36], 		
			[ "10월", 1040, 88, 31.4,40 ], 
			[ "11월", 584, 371, 30.8,28.57],
			[ "12월", 189, 38, 17.9,8.33 ],			 
			[ "1월", 507, 622, 30.9,28.57 ], 
			[ "2월", 886, 191, 27.3,36.36],			 
			[ "3월", 1332, 221, 26.7,14.28 ],
        ];




var FYtd = [ //[ '지점', '목표 금액', '현재 금액 ', '목표M/S','현재M/S' ], 
            [ '지점', '목표 금액', '현재 금액 ', '목표M/S', '현재M/S' ],
  			[ "4월", 1321, 231, 31.1,13.15 ], 
  			[ "5월", 1332, 221, 26.7,14.28 ], 
  			[ "6월", 1523, 361, 34.8,22.58 ], 
...
var currentYear = parseInt(d.getFullYear().toString().substring(2,4))+1; //0=January, 1=February etc.
